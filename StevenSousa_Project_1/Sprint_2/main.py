...
programmatically parse the rapid_jobs2.json file in order to save each job into a PostgreSQL DB and provide the
ability to send any job from the DB as a prompt to Google AI Studio.
"""
